...
export default function App() {
  ...
  const applyInspect = () => {
    ...
    const anyDone=newItems.some(it=>it.receivedQty>0);
    const newStatus=allDone?"received":anyDone?"partial":"ordered";
    setOrders(prev=>prev.map(o=>o.id===order.id?{...o,items:newItems,status:newStatus,deliveryDate:allDone?today():o.deliveryDate}:o));
